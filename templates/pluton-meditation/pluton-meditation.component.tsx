    ...
    <div className={cn([styles.meditationMeeting, className])} {...otherProps}>
      ...
      <div className={styles.wrapper}>
        ...
        <div className={styles.item}>
          ...
          <Typography className={styles.itemText} variant="text">
            Эту задачу передал нам наш род. Когда-то эти задачи не была решены и нам стоит
            поработать над ними. Эта задача будет являться нашей проблемной зоной для достижения
            успеха. Родовое число показывает наш внутриутробный период: как проходила беременность
            мамы, что она испытывала и какие задачи решала. Число показывает наши проявления в
            социуме. Пока родовое число находится в минусе и задача не проработана - потенциал
            базового числа не раскроется! Родовое число — это наша теневая сторона. Важно принять в
            себе отрицательные аспекты по вашему родовому числу, вывести их в плюс и сделать
            ресурсом. Ведь очень часто дети повторяют сценарии родителей, потому что родовое число
            остаётся в минусе, задачи по нему не решены.
          </Typography>
          <PlayerAudio

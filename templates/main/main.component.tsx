			...
			<Container>
				<div className={styles.head}>
					...
					<div className={styles.text}>
						...
						Уточняющие вопросы можно задать по номеру +375 29 777-27-77.
					</div>
				</div>
				...
				<Typography className={styles.payInfo}>
					...
					<div>
						...
						службу технической поддержки) по телефону <br /> +375 29 777-27-77 или e-mail
				...
				<Typography variant='text' className={styles.userText}>
					...
					УНП 391632524 <br />
					Почтовый адрес: 211875, Республика Баларусь, г. Поставы, ул. Юбилейная 12/51
					<br />
					...
					211875, Республика Баларусь, г. Поставы, ул. Юбилейная 12/51 <br />
					Тел.: +375 29 777-27-77 <br />
